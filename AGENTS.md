...
- Run tests (42 tests): `lake build Tests`
- Run CLI integration tests (35 tests): `lake build audit && lake build test_cli && lake exe test_cli`
...
- **Test Suite**: Run `lake build Tests` — 42 `run_cmd` tests across 10 files. Build failure = test failure.
